...
public class AllocatorWorkAreaJPanel extends javax.swing.JPanel {
    ...
    private AllocatingOrganization allocateOrganization;
    
    /**
     * Creates new form LabAssistantWorkAreaJPanel
     */
    public AllocatorWorkAreaJPanel(JPanel userProcessContainer, UserAccount account, Organization organization, EcoSystem business) {
        initComponents();
        
        this.userProcessContainer = userProcessContainer;
        this.userAccount = account;
        this.business = business;
        this.allocateOrganization = (AllocatingOrganization)organization;
        populateTable();
    }
