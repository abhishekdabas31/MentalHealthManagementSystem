...
import Business.Organization.AllocatingOrganization;
...
public class BillGeneratorWorkAreaJPanel extends javax.swing.JPanel {
    ...
    private BillingsOrganization billOrganization;
     ...
     */
    public BillGeneratorWorkAreaJPanel(JPanel userProcessContainer, UserAccount account, Organization organization, Enterprise enterprise, EcoSystem business) {
        initComponents();

        this.userProcessContainer = userProcessContainer;
        this.userAccount = account;
        this.business = business;
        this.billOrganization = (BillingsOrganization) organization;
