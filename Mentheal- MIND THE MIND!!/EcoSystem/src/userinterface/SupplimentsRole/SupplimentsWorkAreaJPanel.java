...
public class SupplimentsWorkAreaJPanel extends javax.swing.JPanel {
    ...
    private SupplimentsOrganization supplimentsOrganization;
     ...
     */
    public SupplimentsWorkAreaJPanel(JPanel userProcessContainer, UserAccount account, Organization organization, Enterprise enterprise, EcoSystem business) {
        initComponents();
        
        this.userProcessContainer = userProcessContainer;
        this.userAccount = account;
        this.business = business;
        this.supplimentsOrganization = (SupplimentsOrganization)organization;
