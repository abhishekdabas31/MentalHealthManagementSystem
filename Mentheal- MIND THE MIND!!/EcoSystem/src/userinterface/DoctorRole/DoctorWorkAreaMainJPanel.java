...
public class DoctorWorkAreaMainJPanel extends javax.swing.JPanel {
     ...
     */
    public DoctorWorkAreaMainJPanel(JPanel userProcessContainer, UserAccount account, DoctorOrganization organization, Enterprise enterprise,EcoSystem business,DoctorSchedule sched) {
        initComponents();
    ...
    private void processJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_processJButtonActionPerformed
        ...
        DoctorWorkAreaJPanel doctorWorkAreaJPanel = new DoctorWorkAreaJPanel(userProcessContainer, userAccount, (DoctorOrganization)organization, enterprise,business,request.getPatient());
